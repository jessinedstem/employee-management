...
public class EmployeeServiceTest {
    ...
    public void testAddEmployee() {
        EmployeeRequest mockEmployeeRequest =
                EmployeeRequest.builder()
                        .name("Jessin")
                        .email("jessin@gmail.com")
                        .department("EEE")
                        .build();
        EmployeeResponse mockEmployeeResponse =
        ...
        when(modelMapper.map(mockEmployee, EmployeeResponse.class))
                .thenReturn(mockEmployeeResponse);
    ...
    public void testGetEmployeesByDepartment() {
        ...
        EmployeeResponse mockEmployeeResponseList1 =
                EmployeeResponse.builder()
                        .employeeId(1L)
                        .name("Jessin")
                        .email("jessin@gmail.com")
                        .department("EEE")
                        .build();
        EmployeeResponse mockEmployeeResponseList2 =
                EmployeeResponse.builder()
                        .employeeId(1L)
                        .name("Jessi")
