...
public class EmployeeControllerTest {
    ...
    public void testGetEmployeesByDepartment() throws Exception {
        ...
        when(employeeService.getEmployeesByDepartment(mockDepartment))
                .thenReturn(mockEmployeeResponseList);
        mockMvc.perform(
                        get("/employee/get-byDepartment")
